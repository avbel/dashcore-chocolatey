...
$url        = "https://github.com/dashpay/dash/releases/download/v$($version)/dashcore-$($version)-win32-setup.exe"
$url64      = "https://github.com/dashpay/dash/releases/download/v$($version)/dashcore-$($version)-win64-setup.exe"
